    ...
    if spike:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                rtt_list.append(rtt)
                count += 1
                print(f"[{count}] RTT: {rtt:.4f} seconds | average RTT: {sum(rtt_list)/count:.4f} seconds")
                ...
                try:
                    ...
                    print(f"[{count}] Server Result: name: {server_result.get('identified', 'unknown')} | similarity: {server_result.get('score', 0):.3f}")
