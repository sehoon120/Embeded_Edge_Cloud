...
def detect_person_and_prepare_file(frame, model, face_cascade, default_files, mem, spike, mem_list, x_list, spike_list):
    # YOLOv8 Inference
...
while True:
    ...
    files, mem, spike, filename = detect_person_and_prepare_file(
        frame, model, face_cascade, default_files, mem, spike, mem_list, x_list, spike_list
    )
