...
def detect_person_and_prepare_file(frame, model, face_cascade, default_files, mem1, mem2, spike):
    # YOLOv8 Inference
    ...
    for result in results:
        rbox = result.boxes.cpu()
        classes = rbox.cls.numpy()
...
while True:
    ...
    files, mem1, mem2, spike, filename = detect_person_and_prepare_file(
        frame, model, face_cascade, default_files, mem1, mem2, spike)
